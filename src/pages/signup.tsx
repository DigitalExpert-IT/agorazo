...
export default function Signup() {
  ...
  const {registerUser, isLoading, showToast, setShowToast, response} = UseRegister();
    ...
    <AuthLayout>
      <div className="container relative z-1">
        <div className="flex justify-center">
          <div className="max-w-[400px] w-full m-auto p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
            ...
            <form onSubmit={handleSubmit(handleRegister)} action="signup-success.html" className="text-start">
              <div className="grid grid-cols-1">
                    ...
                    {...register("password", 
                      { required: true,
                        pattern: {
                          ...
                          message: "Password must be at least 8 characters, include 1 number, 1 uppercase letter, and 1 special character"
                        }
                      })}
                    id="LoginPassword"
                ...
                {errors.accept && <span className="text-red-500 text-sm">{errors.accept.message}</span>}
      ...
      {showToast && (
        <Toast 
          ...
          message={response?.error ? response?.error || "An error occurred during registration." : response?.message || "Registration successful!"} 
